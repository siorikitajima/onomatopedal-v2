...
var sampler = new Tone.Sampler({
		"B3": "v2/sounds/PyonPyonStems/B3.mp3",
		"C#4": "v2/sounds/PyonPyonStems/Cm4.mp3",
		"G#5": "v2/sounds/PyonPyonStems/Gm5.mp3"
}, {
	'release' : 1,
	'onload' : function(){
		console.log('ready');
...
function makeChannel(name, url, pan=0) {
  ...
  const player = new Tone.Player({
    url: `v2/sounds/PyonPyonStems/${url}.mp3`,
    loop: true
  }).sync().start(0);
